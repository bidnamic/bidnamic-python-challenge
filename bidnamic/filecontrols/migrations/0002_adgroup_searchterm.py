    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('campaign', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='filecontrols.campaign', verbose_name='Connected Campaign')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ad_group', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='filecontrols.adgroup', verbose_name='Connected Ad Group')),
                ('campaign', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='filecontrols.campaign', verbose_name='Connected Campaign')),
            ],
            options={
